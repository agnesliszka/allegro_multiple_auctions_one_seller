...
with open('stored_links_first_search.json', 'r') as data_file:
    ...
    for list_with_offers in data:
        for item in list_with_offers:
            ...
            if i<10:
                path = f'allegro_offers_first_search/offer_000{i}.html'
            elif i<100:
                path = f'allegro_offers_first_search/offer_00{i}.html'
            elif i<1000:
                path = f'allegro_offers_first_search/offer_0{i}.html'
            else:
                path = f'allegro_offers_first_search/offer_{i}.html'
