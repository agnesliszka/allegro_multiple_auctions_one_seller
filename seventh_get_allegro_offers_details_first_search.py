...
def get_details(_data):
    ...
    try:
        ...
        offers_data_first_search['offer_id'] = filtered
    except:
        try:
    ...
    try:
        ...
        offers_data_first_search['seller_id'] = filtered
    except:
        try:
    ...
    try:
        ...
        offers_data_first_search['title'] = filtered
    except:
        try:
            ...
            # offers_data_first_search['title'] = filtered.text

    # Search for price
    try:
        filtered = soup.find(itemprop="price")
        print("price : " + filtered.get('content'))
        offers_data_first_search['price'] = float(filtered.get('content'))
    except:
        ...
        offers_data_first_search['price'] = filtered_price+filtered_cents
    ...
    try:
        ...
        print("url: " + filtered)
        offers_data_first_search['url'] = filtered
    except:
        try:
...
with open('stored_offers_data_first_search.json', 'w', encoding="utf-8") as data_file:
    offers = os.listdir('allegro_offers_first_search')
    for offer in offers:
        offers_data_first_search = {}
        ...
        output.append(offers_data_first_search)
