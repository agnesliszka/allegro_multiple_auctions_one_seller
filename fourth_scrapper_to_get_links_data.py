...
with open('stored_links.json', 'r') as data_file:
    ...
    for list_with_offers in data:
        for item in list_with_offers:
            print(item)
            offers = os.listdir('allegro_offers')
            ...
            if i<10:
                path = f'allegro_offers/offer_000{i}.html'
            elif i<100:
                path = f'allegro_offers/offer_00{i}.html'
            elif i<1000:
                path = f'allegro_offers/offer_0{i}.html'
            else:
                path = f'allegro_offers/offer_{i}.html'
