...
url_list = ['https://allegro.pl/listing?string=butelka%20lovi%20250%20ml&bmatch=baseline-eyesa2-dict43-bab-1-4-0205']
links_data_list = []
...
def get_next_page_with_links():
    ...
    url = 'https://allegro.pl/listing?string=butelka%20lovi%20250%20ml&bmatch=baseline-eyesa2-dict43-bab-1-4-0205'
    for i in range(5):
